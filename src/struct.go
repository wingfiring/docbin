...
/*
Package zip2 provides support for reading and writing ZIP archives.
...
func FileInfoHeader(fi os.FileInfo) (*FileHeader, error) {
	size := fi.Size()
	if size > (1<<32 - 1) {
		return nil, errors.New("zip2: file over 4GB")
	}
	fh := &FileHeader{
		Name:             fi.Name(),
...
func (h *FileHeader) SetMode(mode os.FileMode) {
	...
	// set MSDOS attributes too, as the original zip2 does.
